    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('male', 'Мужской'), ('female', 'Женский')], null=True)),
                ('language', models.CharField(blank=True, choices=[('ru', 'Русский'), ('eu', 'English')], null=True)),
