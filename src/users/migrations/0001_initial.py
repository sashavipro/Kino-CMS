    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, choices=[('kiev', 'Киев'), ('kharkov', 'Харьков'), ('odessa', 'Одесса')], max_length=60, null=True)),
                ('gender', models.CharField(blank=True, choices=[('male', 'Мужской'), ('female', 'Женский')], max_length=10, null=True)),
                ('language', models.CharField(blank=True, choices=[('ru', 'Русский'), ('eu', 'English')], max_length=2, null=True)),
